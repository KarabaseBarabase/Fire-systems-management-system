...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('system_subtypes', function (Blueprint $table) {
            $table->id('subtype_id');
            $table->foreignId('type_id')->constrained('system_types')->onDelete('cascade');
            $table->string('name', 50);
            $table->string('description', 200)->nullable();
        });
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->smallInteger('branch_id')->nullable()->constrained('branches');
        ...
        Schema::create('protection_objects', function (Blueprint $table) {
            ...
            $table->smallInteger('branch_id')->constrained('branches');
            $table->string('name', 200);
            $table->string('short_name', 100)->nullable();
            $table->foreignId('object_group_id')->constrained('object_groups');
        ...
        Schema::create('fire_systems', function (Blueprint $table) {
            $table->id('system_id');
            $table->uuid('record_uuid')->unique()->default(DB::raw('gen_random_uuid()'));
            $table->foreignId('object_id')->nullable()->constrained('protection_objects')->onDelete('set null');
            $table->foreignId('subtype_id')->nullable()->constrained('system_subtypes')->onDelete('set null');
        ...
        Schema::create('implemented_projects', function (Blueprint $table) {
            $table->id('project_id');
            $table->uuid('record_uuid')->unique()->default(DB::raw('gen_random_uuid()'));
            $table->foreignId('system_id')->constrained('fire_systems')->onDelete('cascade');
            $table->string('project_code', 100);
            $table->integer('development_year');
            $table->foreignId('design_org_id')->constrained('design_organizations');
        ...
        Schema::create('repairs', function (Blueprint $table) {
            ...
            $table->foreignId('installation_org_id')->nullable()->constrained('installation_organizations');
        ...
        Schema::create('mounts', function (Blueprint $table) {
            ...
            $table->uuid('record_uuid')->unique()->default(DB::raw('gen_random_uuid()'));
            $table->foreignId('system_id')->constrained('fire_systems')->onDelete('cascade');
            $table->foreignId('installation_org_id')->constrained('installation_organizations');
        ...
        Schema::table('equipments', function (Blueprint $table) {
            $table->index('system_id');
            $table->index('type_id');
            $table->index(DB::raw('(production_year + service_life_years)'));
        ...
        Schema::create('new_projects', function (Blueprint $table) {
            ...
            $table->foreignId('design_org_id')->nullable()->constrained('design_organizations');
